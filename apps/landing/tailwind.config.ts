...
export default {
  ...
  content: [
    ...
    './partners/midday/src/components/**/*.{ts,tsx}',
    './partners/cap/components/**/*.{ts,tsx}',
    './partners/inboxzero/components/**/*.{ts,tsx}',
    './partners/supabase/components/**/*.{ts,tsx}',
    './partners/dub/ui/**/*.{ts,tsx}',
    './partners/outline/components/**/*.{ts,tsx}',
    './partners/plane/core/components/**/*.{ts,tsx}',
    './partners/teable/src/components/**/*.{ts,tsx}',
    '!**/node_modules/**',
  ],
  theme: {
    extend: {
